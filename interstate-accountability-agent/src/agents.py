...
accountability_agent = Agent(
    ...
    goal=(
        ...
        "and autonomously file a legal report to the CAQM leadership."
    ),
    backstory=(
        ...
        "You must correlate CPCB border station data, "
        "NASA fire counts, and DSS source "
        "apportionment reports to build an "
        "iron-clad legal case for enforcement under Section 12 of the CAQM Act."
    ),
    tools=[read_correlated_data_tool, send_caqm_report],
    verbose=True,

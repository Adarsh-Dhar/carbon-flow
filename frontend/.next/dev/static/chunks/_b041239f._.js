            ...
            map.on("load", {
                "SensorMap.useEffect": ()=>{
                    const features = Array.from({
                        ...
                        "SensorMap.useEffect.features": (_, idx)=>({
                                type: "Feature",
                                geometry: {
                                    type: "Point",
                                    coordinates: [
...
_s(SensorMap, "8uVE59eA/r6b92xF80p7sH8rXLk=");
_c = SensorMap;
